...
CURRENT CAPABILITIES: `century1.html` is the selected runtime; three original HTML prototypes remain preserved; package/build/typecheck/test scripts are established.
...
NEXT PHASE: Phase 1 — playable city and superhuman traversal expansion.
